 ...
 * $config['rest_db_auth'] 
 * 
 * TRUE: Autentica por base de datos, teniendo en cuenta el nombre de usuario (email) y contraseña 
 * del usuario que realiza la solictud.
 * FALSE : autentica por el array  $config['rest_valid_logins'] con el par usuario - contraseña
 * */
$config['rest_db_auth'] = FALSE;